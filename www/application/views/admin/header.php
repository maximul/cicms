...
<div align="center">
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#000000">
		<tr>
			<td width="100%"><font color="#bbc0f0" face="Arial" size="2"><b class="h">&nbsp;&nbsp; |&nbsp;&nbsp; <?= anchor('admin',
"Главная") ?>&nbsp;&nbsp; |&nbsp;&nbsp; <?= anchor('admin/pages/index/list',
"Страницы") ?>&nbsp;&nbsp; |&nbsp;&nbsp; <?= anchor('admin/links/index/list',
"Ссылки") ?>&nbsp;&nbsp; |&nbsp;&nbsp; <?= anchor('admin/images/index/list',
"Картинки") ?>&nbsp;&nbsp; |&nbsp;&nbsp; <?= anchor('admin/settings',
"Настройки") ?>&nbsp;&nbsp; |&nbsp;&nbsp; <?= anchor('admin/logout',
"Выход") ?>&nbsp;&nbsp; |</b></font></td>
		</tr>
	</table>
